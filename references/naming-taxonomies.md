...
Read this file when generating names in Phase 2 (Divergent Generation). Use it to ensure coverage across all naming categories and to ground your suggestions in proven linguistic patterns rather than defaulting to whatever feels "safe."

## Table of Contents
1. [The Eleven Naming Categories](#the-eleven-naming-categories)
2. [Motion & Direction as a Naming Angle](#motion--direction-as-a-naming-angle)
3. [Phonesthetic Framework](#phonesthetic-framework)
4. [Anti-Patterns: The LLM Naming Trap](#anti-patterns)
5. [Cross-Language Pitfalls](#cross-language-pitfalls)
...
When exploring variants of a promising name or concept in Phase 6, use these eight transformation axes. Each axis produces a different type of candidate.
